...
class SimpleProtobuf:
    ...
    def create_login_payload(open_id, access_token, platform):
        ...
        payload.extend(SimpleProtobuf.encode_string(7, '2.123.1'))
...
inspect_url = f"https://100067.connect.garena.com/oauth/guest/token/grant={access_token}"
inspect_headers = {
...
GetLoginData_resURL = "https://loginbp.ggpolarbear.com/GetLoginData"
